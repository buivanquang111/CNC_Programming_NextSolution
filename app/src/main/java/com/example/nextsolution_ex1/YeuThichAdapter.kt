...
class YeuThichAdapter internal constructor(context: Context, val cncDB: CNCDataBase): RecyclerView.Adapter<YeuThichAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): YeuThichAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_yeuthich,parent,false)
